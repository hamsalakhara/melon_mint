...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="{{ asset('assets/images/whatsappmini.svg') }}" />
...
jQuery(document).ready(function($) {
    // Initialize intlTelInput on #whatsapp_no
    const input = document.querySelector("#whatsapp_no");
    ...
    // Update #whatsapp_no2 on form submit
    $("#saveProfile").click(function(event) {
        //event.preventDefault(); // Prevent the form from submitting for testing purposes
        $("#whatsapp_no2").val(iti.getNumber());
        //alert($("#whatsapp_no2").val());
        // Uncomment the following line to allow the form to submit
